...
class programacion extends conexionPDO
{
    ...
    public function crear_toda_prog_semanal($estado, $id_cliente, $id_obra,  $id_pedido, $id_producto,  $cantidad,$fecha_ini, $fecha_fin){
        ...
        $sql = "INSERT INTO `ct66_prog_semanal`(`status`, `id_cliente`, `nombre_cliente`, `id_obra`, `nombre_obra`, `id_pedido`, `id_producto`, `nombre_producto`, `cantidad`, `fecha_ini`, `fecha_fin`) VALUES (:estado, :id_cliente, :nombrecliente, :id_obra, :nombre_obra, :id_pedido, :id_producto, :nombre_producto :cantidad, :fecha_ini, fecha_fin)";
