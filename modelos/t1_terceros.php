...
class t1_terceros extends conexionPDO
{
    ...
    function crear_cliente($tipo_cliente, $formapago, $naturaleza, $tipo_documento, $numero_documento, $dv, $razon_social, $nombre1, $nombre2, $apellido1, $apellido2, $genero, $fecha_naci, $departamento, $municipio, $direccion, $email, $telefono, $celular, $cupo, $saldo_cartera)
    {
        ...
        $sql = "INSERT INTO `ct1_terceros`( `ct1_Estado`, `ct1_naturaleza`, `ct1_TipoTercero`, `ct1_TipoIdentificacion`, `ct1_NumeroIdentificacion`, `ct1_dv`, `ct1_RazonSocial`, `ct1_Nombre1`, `ct1_Nombre2`, `ct1_Apellido1`, `ct1_Apellido2`,   `ct1_usuario`, `ct1_pass`, `ct1_rol`, `ct1_FechaNacimiento`, `ct1_Telefono`, `ct1_Celular`, `ct1_CorreoElectronico`,  `ct1_Departamento`, `ct1_Ciudad`, `ct1_Direccion` ) VALUES  ( :estado , :naturaleza, :tipo_tercero,              :tipo_identificacion, :numero_identificacion,      :dv , :razon_social,          :nombre1, :nombre2 , :apellido1, :apellido2 ,  :usuario , :pass , :rol,:fecha_nacimiento,   :telefono , :cel, :email,  :departamento, :ciudad, :direccion )";
        //Preparar Conexion
        $stmt = $this->con->prepare($sql);
