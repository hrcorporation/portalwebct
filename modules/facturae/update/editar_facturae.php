                        ...
                        <div class="col-2">
                            <div class="form-group">
                                <label> <input type="radio" class="form-control tipoarchivo" name="subirtipo"
                                        value="image/x-png,image/jpeg"   id="check_tipo_img"  disabled="disabled"> Subir Imagen </label>
                            </div>
                        </div>
                        <div class="col-2">
                            <div class="form-group">
                                <label> <input type="radio" class="form-control tipoarchivo" id="subirpdf"
                                        name="subirtipo" value="application/pdf"  id="check_tipo_pdf" checked=""  disabled="disabled"> Subir PDF </label>
                            </div>
                        </div>
