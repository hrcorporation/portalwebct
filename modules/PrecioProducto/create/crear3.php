                            ...
                            <div id="contenido">
                                ...
                                <div class="row">
                                    <div class="col-md-6">
                                        <div class="form-group">
                                            ...
                                            <select class="form-control select2 " style="width: 100%;" id="Txb_IdTercero" name="Txb_IdTercero" data-select2-id="" tabindex="-1" aria-hidden="true"></select>
                                    ...
                                    <div class="col-md-6">
                                        <div class="form-group">
                                            ...
                                            <select class="form-control select2 " style="width: 100%;" id="Txb_IdObras" name="Txb_IdObras" data-select2-id="" tabindex="-1" aria-hidden="true">
                                ...
                                <div class="row">
                                    <div class="col-md-12">
                                        <div class="form-group">
                                            <label> Precio ($) </label>
                                            <input class="form-control" type="text" name="Txb_Precio" id="Txb_Precio" onkeyup="format(this)" placeholder="">
                                        </div>
                                    </div>
                                </div><br>
        ...
        $(document).ready(function (e) {
            ...
            $.ajax({
                ...
                success: function (response) {
                    ...
                    if (response.estado) {
                        $('#Txb_IdProducto').html(response.producto);
                        //$('#cupocliente').html(response.cupclient);
                    } else {
                            ...
                            success: function (data)
                            {
                                if (data.estado) {
                                    ...
                                    if (data.error === 3) {
                                        ...
                                        console.log("No Se encuentran Errores =" + data.msg);
                                        toastr.info('Contactar al Soporte');
                                    }
                                }
