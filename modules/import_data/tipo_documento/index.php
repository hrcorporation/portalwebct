    ...
    <section class="content">
        ...
        <div class="card">
            ...
            <div class="card-body">
                ...
                <form name="form_tipo_documento" id="form_tipo_documento" method="post">
                    <div class="row">
                        <div class="col">
                            <div class="form-group">
                                <label>Seleccionar Archivo</label>
                                <!-- input para seleccionar el archivo -->
                                <input type="file" class="form-control" name="file_tipo_documento" id="file_tipo_documento" />
                            </div>
                        </div>
                    </div>
                    <div class="row">
