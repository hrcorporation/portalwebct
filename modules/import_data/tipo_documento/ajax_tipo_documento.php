...
if (is_array($array_reg)) {
    foreach ($array_reg as $row) {
        ...
        if (!is_null($row[0])) {
            ...
            $new_array['nom_ref1'] = $row[68];
            $new_array['nom_ref2'] = $row[69];
            $new_array['nom_ref3'] = $row[70];
            $new_array['nom_ref4'] = $row[71];
            $new_array['cta1'] = $row[72];
            $new_array['cta2'] = $row[73];
            $new_array['cta3'] = $row[74];
            $new_array['cta4'] = $row[75];
            $new_array['cta5'] = $row[76];
            $new_array['cta6'] = $row[77];
            $new_array['cta7'] = $row[78];
            $new_array['cta8'] = $row[79];
            $new_array['cta9'] = $row[80];
            $new_array['cta10'] = $row[81];
            $new_array['ncta1'] = $row[82];
            $new_array['ncta2'] = $row[83];
            $new_array['ncta3'] = $row[84];
            $new_array['ncta4'] = $row[85];
            $new_array['ncta5'] = $row[86];
            $new_array['ncta6'] = $row[87];
            $new_array['ncta7'] = $row[88];
            $new_array['ncta8'] = $row[89];
            $new_array['ncta9'] = $row[90];
            $new_array['ncta10'] = $row[91];
            $new_array['externo'] = $row[92];
            $new_array['lprefij'] = $row[93];
            $new_array['modo'] = $row[94];
            $new_array['noimpnit'] = $row[95];
            $new_array['impposval'] = $row[96];
            $new_array['impitagru'] = $row[97];
            $new_array['impitagrux'] = $row[98];
            $new_array['impobli'] = $row[99];
            $new_array['inveperio'] = $row[100];
            $new_array['porfpago'] = $row[101];
            $new_array['bodega_item'] = $row[102];
            $new_array['recostea'] = $row[103];
            $new_array['vendedor'] = $row[104];
            $new_array['ctaretev'] = $row[105];
            $new_array['ctaretem'] = $row[106];
            $new_array['ctaretes'] = $row[107];
            $new_array['ctaretec'] = $row[108];
            $new_array['retiva'] = $row[109];
            $new_array['noitdocu'] = $row[110];
            $new_array['contabtr'] = $row[111];
            $new_array['pda'] = $row[112];
            $new_array['aiu'] = $row[113];
            $new_array['esentrada'] = $row[114];
            $new_array['esbaja'] = $row[115];
            $new_array['estransfer'] = $row[116];
            $new_array['esresponsa'] = $row[117];
            $new_array['contaimport'] = $row[118];
            $new_array['dias_plazo'] = $row[119];
            $new_array['ver_colter'] = $row[120];
            $new_array['ver_colref'] = $row[121];
            $new_array['nsalconsec'] = $row[122];
            $new_array['imp_copias'] = $row[123];
            $new_array['for_vende'] = $row[124];
            $new_array['lretfte'] = $row[125];
            $new_array['lretcre'] = $row[126];
            $new_array['lretiva'] = $row[127];
            $new_array['lretica'] = $row[128];
            $new_array['tarica'] = $row[129];
            $new_array['solo_fechoy'] = $row[130];
            $new_array['depend'] = $row[131];
            $new_array['momod_costo'] = $row[132];
            $new_array['trasla'] = $row[133];
            $new_array['traslasuc'] = $row[134];
            $new_array['vrletras'] = $row[135];
            $new_array['sermov'] = $row[136];
            $new_array['smconsecl'] = $row[137];
            $new_array['olectura'] = $row[138];
            $new_array['noconsolid'] = $row[139];
            $new_array['notainv'] = $row[140];
            $new_array['creeuti'] = $row[141];
            $new_array['columniif'] = $row[142];
            $new_array['ctareteiva'] = $row[143];
            $new_array['imprimeniif'] = $row[144];
            $new_array['espcdesc'] = $row[145];
            $new_array['bodemanu'] = $row[146];
            $new_array['meses_hab'] = $row[147];
            $new_array['anexo_obli'] = $row[148];
            $new_array['cambios'] = $row[149];
            $new_array['anop'] = $row[150];
            $new_array['impitdagr'] = $row[151];
            $new_array['fe_nomline'] = $row[152];
            $new_array['fe_nnotify'] = $row[153];
            $new_array['fe_csfe'] = $row[154];
            $new_array['fe_version'] = $row[155];
            $new_array['fe_exporta'] = $row[156];
            $new_array['fe_xmldtos'] = $row[157];
            $new_array['fe_salud'] = $row[158];
            $new_array['fe_saludti'] = $row[159];
            $new_array['causadev'] = $row[160];
            $new_array['refinven'] = $row[161];
            $new_array['nodtos'] = $row[162];
            $new_array['ver_refpro'] = $row[163];
            $new_array['tpexclrede'] = $row[164];
            $new_array['sermovfe'] = $row[165];
            $new_array['grupoper'] = $row[166];
            $new_array['refcompon'] = $row[167];
            $new_array['autoica'] = $row[168];
            $new_array['ver_periodo'] = $row[169];
            $new_array['valnega'] = $row[170];
            $new_array['no_importa'] = $row[171];
