    ...
    <section class="content">
        ...
        <div class="card">
            ...
            <div class="card-body">
                ...
                <form name="form_movimiento_diario" id="form_movimiento_diario" method="post">
                    <div class="row">
                        <div class="col">
                            <div class="form-group">
                                <label>Seleccionar Archivo</label>
                                <!-- input para seleccionar el archivo -->
                                <input type="file" class="form-control" name="file_movimiento_diario" id="file_movimiento_diario" />
                            </div>
                        </div>
                    </div>
                    <div class="row">
...
$("#form_movimiento_diario").on('submit', (function(e) {
    ...
    $.ajax({
        url: "ajax_movimiento_diario.php",
        type: "POST",
