...
// ALTER TABLE `ct1_terceros`  ADD `ct1_tipo_cliente` INT(11) NULL DEFAULT NULL  AFTER `ct1_TipoTercero`;

if (
    isset($_POST['tbx_tipocliente']) && !empty($_POST['tbx_tipocliente']) &&
    ...
    $tipo_cliente = htmlspecialchars($_POST['tbx_tipocliente']);
    ...
    $tipomaestro = htmlspecialchars($_POST['tbx_tipomaestro']);


    
    if(intval($_POST['txt_forma_pago']) == 1)
    {
    ...
    if(intval($_POST['tbx_tipocliente']) == 2)
    {
        $tipomaestro = htmlspecialchars($_POST['tbx_tipomaestro']);
    }else{
        $tipomaestro = NULL;
