...
if (isset($cliente) && !empty($cliente) && isset($obra) && !empty($obra)) {
    $datos_pedidos = $pedidos->excel_pedidos_cliente_obra($cliente, $obra);
    $datos_productos = $pedidos->excel_productos_cliente_obra($cliente, $obra);
    $datos_bomba = $pedidos->excel_bomba_cliente_obra($cliente, $obra);
    $datos_servicio = $pedidos->excel_servicio_cliente_obra($cliente, $obra);
} else if (isset($codigo) && !empty($codigo)) {
    $datos_pedidos = $pedidos->excel_pedidos_codigo($codigo);
    $datos_productos = $pedidos->excel_productos_codigo($codigo);
    $datos_bomba = $pedidos->excel_bomba_codigo($codigo);
    $datos_servicio = $pedidos->excel_servicio_codigo($codigo);
} else {
