...
<div class="content-wrapper">
    <section class="content-header">
        <div class="container-fluid">
            <div class="row mb-2">
                <div class="col-sm-6">
                    <h1>REGISTRAR LISTA DE PRECIOS</h1>
                </div>
                <div class="col-sm-6">
                    <!--
    ...
    <section class="content">
        <?php
        //Se llaman los modelos de las clases de clslistaprecio y oportunidad de negocio.
        $clslistaprecio = new clslistaprecio();
        $oportunidad_negocio = new oportunidad_negocio();
        ?>
        <div class="card">
            <div class="card-header">
                <h3 class="card-title">CREAR LISTA DE PRECIOS</h3>
