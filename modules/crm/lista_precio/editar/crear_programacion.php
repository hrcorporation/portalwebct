...
<div class="content-wrapper">
    ...
    <section class="content">
        ...
        $id_producto = $clslistaprecio->fntGetIdProductoObj($id_precio_producto);
        $cantidad = $clslistaprecio->fntGetCantidadObj($id_precio_producto);
        // SE LLAMA UNA FUNCION PARA OBTENER EL CLIENTE Y LA OBRA DEL PEDIDO
        $datos = $clslistaprecio->get_nombre_cliente_obra($id);
