    ...
    <section class="content">
        ...
        <div class="card">
            <div class="card-header">
                <h3 class="card-title">TABLA DE LA LISTA DE PRECIOS</h3>
            ...
            <div class="card-body">
                <div class="row">
                    <div class="col-3">
                        <a href="create/crear.php" class="btn btn-block btn-success"><i class="fas fa-plus"></i> Crear lista de precios</a>
                    </div>
                    <div class="col-5">
                        <a href="documentos/Formato subir productos al pedidos.xlsx" download="Formato subir productos a la lista de precios.xlsx" class="btn btn-block btn-primary"><i class="fas fa-download"></i> Descargar formato para subir productos a la lista de precios</a>
                    </div>
                    <div class="col-4">
