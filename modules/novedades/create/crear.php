                        ...
                        <div class="row">
                            ...
                            <div class="col-6">
                                <div class="form-group">
                                    ...
                                    <button type="submit" name="btn_crear_novedad" id="btn_crear_novedad" class="btn btn-block btn-success">
                                        Crear novedad
                                    </button>
                                </div>
                            </div>
...
<script>
    $(document).ready(function() {
        // llama al archivo de php_crear_novedad,php para crear las novedades
        ...
        var n = 1;
        // llamar el archivo de php para listar los datos de las fechas de las novedades mediante la fecha
