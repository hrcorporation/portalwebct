                        ...
                        <div class="row">
                            <div class="col-md-6">
                                <div class="form-group">
                                    ...
                                    <input type="text" class="form-control" id="txt_CodTConcreto" name="txt_CodTConcreto" maxlength="2">
                                </div>
                            </div>
                            <div class="col-md-6">
                                <div class="form-group">
                                    <label> Descripcion TC </label>
                                    <input type="text" class="form-control" id="txt_DescripcionTC" name="txt_DescripcionTC">
                                </div>
                            </div>
                        </div>
                        <div class="container">
