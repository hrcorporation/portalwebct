...
$pdf->SetFont('Arial','',11);
$asentamiento = utf8_decode($asentamiento_remi);
...
$pdf->SetFont('Arial','',11);
$hora_salida_remi = 0;
$hora_salida = utf8_decode($hora_salida_remi);
...
$pdf->SetFont('Arial','',11);
$hora_llegada_remi= 0;
$hora_llegada = utf8_decode($hora_llegada_remi);
...
$pdf->SetFont('Arial','',11);
$hora_inicio_remi = 0;
$hora_inicio = utf8_decode($hora_inicio_remi);
...
$pdf->SetFont('Arial','',11);
$hota_terminada_remi = 0;
$hora_terminada = utf8_decode($hota_terminada_remi);
...
$obaservacion_remi = "";
$observaciones = utf8_decode($obaservacion_remi);
