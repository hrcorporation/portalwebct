document.addEventListener("DOMContentLoaded", function () {
  ...
  // Boton Crear Evento
  document.getElementById("btn_crear").addEventListener("click", function () {
    const datos_form = new FormData(form_crear_event);
    var form_crear = new FormData();
    form_crear.append("titulo", form_crear_event.titulo_event.value);
    form_crear.append("start", form_crear_event.start.value);
    form_crear.append("end", form_crear_event.end.value);
    guardar_event(form_crear, calendar);
