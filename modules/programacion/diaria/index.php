        ...
        <div class="card">
            ...
            <div class="card-body">
                ...
                <div class="row">
                    <div class="col-2">
                        <div class="form-group">
                            <button style="position: absolute; right: 20%; top: 40%" type="button" class="btn btn-secondary" id="btnConfirmarProgramacion" data-toggle="modal" data-target="#modal_confirmar_programacion">
                                Sin Confirmar
                            </button>
                        </div>
                    </div>
                    <div class="col-3">
                        <div class="form-group">
                            ...
                            <select name="cbxFrecuencia" id="cbxFrecuencia" class="form-control select2">
