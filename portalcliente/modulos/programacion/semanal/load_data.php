...
if ($_POST['task'] == 1) {
    $select_cliente  = $ClsProgramacionSemanal->fntOptionClienteEditClienteObj($id_usuario);
    $datos = array(
    ...
    $select_obras = $ClsProgramacionSemanal->fntOptionObraEditClienteObj($id_cliente, $id_usuario);
    $php_estado = true;
