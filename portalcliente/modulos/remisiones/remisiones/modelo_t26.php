...
class modelo_t26 extends conexionPDO {
    ...
    function RecibidoFinal_masivo($id_remision, $persona) {
       ...
       $sql = "UPDATE `ct26_remisiones` SET `ct26_notificacion`= :notificacion,`ct26_recibido`= :persona, ct26_fechaRecibido = :fecha, ct26_estado = :estado_remi  WHERE `ct26_id_remision` = :id_remision";
       ...
       $stmt->bindParam(':estado_remi', $this->estado, PDO::PARAM_INT);
    ...
    function observaciones_cli($id_remision, $obs) {
        $this->search_id = $id_remision;
        $this->notificacion = 10;
        $this->observaciones = $obs;

        $sql = "UPDATE `ct26_remisiones` SET `ct26_notificacion`= :notificacion,`ct26_observaciones_cli`= :observaciones WHERE `ct26_id_remision` = :id_remision";
        $stmt = $this->con->prepare($sql);
        $stmt->bindParam(':notificacion', $this->notificacion, PDO::PARAM_INT);
        $stmt->bindParam(':observaciones', $this->observaciones, PDO::PARAM_STR);
        $stmt->bindParam(':id_remision', $this->search_id, PDO::PARAM_INT);
