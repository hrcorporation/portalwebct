                    ...
                    <nav class="mt-2">
                        <ul class="nav nav-pills nav-sidebar flex-column" data-widget="treeview" role="menu" data-accordion="false">
                            ...
                            <li class="nav-item has-treeview menu-open">
                                ...
                                <ul class="nav nav-treeview menu-open">
                                    <li class="nav-item active">
                                        <a href="crear_usuario.php" class="nav-link active">
                                            <i class="far fa-circle nav-icon"></i>
                                            <p>Crear Usuario</p>
                                        </a>
                                    </li>
                                ...
                                <form name="F_CrearUSuario" id="F_CrearUSuario" method="POST">
                                    ...
                                    <div class="row">
                                        <div class="col">
                                            <div class="form-group">
                                                <label>Usuario</label>
                                                <input name="C_Usuario" id="C_Usuario" type="text" class="form-control" placeholder="Digite un Usuario Para iniciar Sesion">
                                            </div>
                                        </div>
                                        <div class="col">
                                            <div class="form-group">
