...
CREATE TABLE `ordenpyg` (
  ...
  `niv1pyg` varchar(100) DEFAULT NULL,
  `niv2pyg` varchar(100) DEFAULT NULL,
  `niv3pyg` varchar(100) DEFAULT NULL,
  `niv4pyg` varchar(100) DEFAULT NULL,
  `idniv4` int(10) DEFAULT NULL,
  `idniv3` int(10) DEFAULT NULL,
